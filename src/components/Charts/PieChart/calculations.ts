...
export const getXOffsetMultiplayerByAngle = (angle: number) => Math.cos(angle - 90 * radian);

export const getYOffsetMultiplayerByAngle = (angle: number) => Math.sin(angle - 90 * radian);
